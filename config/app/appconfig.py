...
class AppConfiguration:
    ...
    def option_dict(self, sec):
        return {opt: self._cp.getint(sec, opt) for opt in self._cp.options(sec)}

    def to_dict(self):
        return {sec: self.option_dict(sec) for sec in self._cp.sections()}
